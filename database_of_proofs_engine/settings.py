"""
Django settings for database_of_proofs_engine project.
...
ROOT_URLCONF = 'database_of_proofs_engine.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATES_PATH, 
                 os.path.join(TEMPLATES_PATH, 'database_of_proofs_engine'),
...
WSGI_APPLICATION = 'database_of_proofs_engine.wsgi.application'
...
MAX_TEXT_LENGTH = 80
MAX_DIAGRAM_TEXT_LENGTH = 60
MAX_DIAGRAM_NAME_LENGTH = 120
